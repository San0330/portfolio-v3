...
const ResumeDownloadButton = () =>
    <button
        className='bg-white shadow-xl mt-5 text-gray-600 border border-gray-300 inline-flex justify-center gap-2 w-36 text-center rounded-lg px-5 py-3 cursor-pointer uppercase tracking-widest'
